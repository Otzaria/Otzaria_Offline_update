...
class CustomAppLocator {
  ...
  /// עומק הסריקה בתוך תיקיית מועמדת, בחיפוש לרוחב — אותו שיקול שתועד
  /// ב-`OtzariaAppLocator`: סריקה עמוקה ולא-מסודרת מחזירה תשובות שונות
  /// במחשבים שונים, ועלולה לטייל בתוך עץ ענק.
  ///
  /// ⚠️ **חייב להיות זהה ל-`OtzariaAppLocator.defaultWindowsMaxDepth`**, שהוא
  /// הסורק שהלמידה שאחרי ההתקנה עוברת דרכו. כשהיה כאן 2 ושם 3, exe שיושב
  /// שתי רמות מתחת לתיקיית ההתקנה נלמד בהצלחה ואז לא נמצא לעולם: הרשומה
  /// קיבלה שם קובץ הרצה תקין, והכרטיס דיווח "אינה מותקנת".
