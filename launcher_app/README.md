...
### חלוקת התוכנות הנוספות: ניהול בהגדרות, שימוש במסך
...
הוספה, עריכה והסרה — יושב ב-`custom_apps/custom_apps_settings_card.dart`,
כרטיס במסך ההגדרות שיש בו שורה לכל תוכנה. `CustomAppsScreen` נשאר למה
