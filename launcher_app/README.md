...
מעליהם סרגל זהות קבוע (`AppShell._TopBar`): סמל אוצריא
(`assets/images/otzaria_logo.png`) ושם התוכנה בלבד. מחווני המצב שהיו בו
(רשת, תיקיית הנתונים, "נבדק ב־", אזהרה כשאוצריא פתוחה) הוסרו — כולם
