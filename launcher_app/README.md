...
לתוספים, במסך התוכנות הנוספות. שלושה דברים בה אינם מקריים:
...
ו-`otzaria_install_state.json` — ושם גם מקומם: "איזו גרסה מותקנת" היא
תכונה של המחשב, לא של הכונן. ההעדפות מועתקות פעם אחת מהכונן
(`AppPaths.seedPreferences`), קובצי המצב לא — הם מתארים את מי שכתב אותם.
